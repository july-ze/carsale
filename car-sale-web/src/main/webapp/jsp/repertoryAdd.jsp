    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form id="addCustomer" data-parsley-validate class="form-horizontal form-label-left"
                  action="${pageContext.request.contextPath}/order/insertOrder" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="carPrice" readonly="readonly" name="carPrice"
                ...
                <div class="form-group">
                    ...
                    <p id="orderNum_p"
                       style="margin-bottom: 0px;border-left-width: 0px;padding-left: 130px;padding-top: 5px;">
                        1:
